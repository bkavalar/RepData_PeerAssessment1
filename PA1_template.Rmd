...
hist(sumData$Total_Steps, col = "cyan", xlab = "Total Number of Steps Per Day Over the Range",
	 ylim = range(0, 40), main="Histogram of Number of Steps Per Day With No NA Data")

```

###Also need to present the mean and median number of steps:
```{r}
...
#create histogram of the number of steps per day and the frequency 
hist(sumData$Total_Steps, col = "cyan", xlab = "Total Number of Steps Per Day Over the Range", 
	 ylim = range(0, 40), main="Histogram of Number of Steps Per Day using Mean Data for NA's")
